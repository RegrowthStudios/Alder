<?php
    ...
    class Factory
    {
         ...
         */
        private function createContainedEqualsTo(string $name, $value): ContainedEqualsTo
        {
         ...
         */
        private function createContainsEqualsTo(string $name, $value): ContainsEqualsTo
        {
