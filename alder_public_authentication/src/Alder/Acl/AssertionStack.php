<?php
    ...
    class AssertionStack implements AssertionInterface, \ArrayAccess, \Iterator
    {
         ...
         * 
         * @param \Zend\Permissions\Acl\Assertion\AssertionInterface $assert The assertion to push to the end of the stack.
         */
         ...
         * 
         * @return \Zend\Permissions\Acl\Assertion\AssertionInterface $assert The assertion popped off the end of the stack.
         */
         ...
         * 
         * @param \Zend\Permissions\Acl\Assertion\AssertionInterface $assert The assertion to add to the front of the stack.
         */
         ...
         * Pops an assertion off the end of a stack.
         * 
         * @return \Zend\Permissions\Acl\Assertion\AssertionInterface $assert The assertion shifted off the front of the stack.
         */
